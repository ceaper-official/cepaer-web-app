...
import FeedBack from "@icons/ui/feedback.js";
import Bug from "@icons/ui/bug.js";
import StarSolid from "@icons/ui/star-solid.js";
import Rate5 from "@icons/ui/rate5.js";
import Rate4 from "@icons/ui/rate4.js";
import Rate3 from "@icons/ui/rate3.js";
import Rate2 from "@icons/ui/rate2.js";
import Rate1 from "@icons/ui/rate1.js";
import $ from "jquery";

$(function () {
  $("#fb1 a").click(function () {
    $("#fb2").fadeIn(400);
  });
  $("#fb2 a").click(function () {
    $("#fb3").fadeIn(400);
  });
});
      ...
      <BaseLayout>
        <div id="page">
          ...
          <div className="contents">
            <div className="section center-section">
              <div className="feedback-wrapper" id="fb1">
              ...
              <div className="feedback-wrapper" id="fb2" hidden>
                <h5 className="hr-section-title">
                  Ceaperのサービスに満足していますか？
                </h5>
                {/* ホバー で、選択。フォームにデータ出力 */}
                <div className="form-select">
              ...
              <div className="feedback-wrapper" id="fb3" hidden>
                ...
                <a className="button button-snow form-submit">
                  フィードバックを送る
                </a>
              </div>
            </div>
