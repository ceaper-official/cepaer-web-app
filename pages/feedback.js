  ...
  <div id="page">
    <div className='contents bg-grey'>
      <div className='section center-section'>
        ...
        <p>私達Ceaperは常にユーザーの方が心地良くサービスを使えるように新しい機能の開発・修正に挑んでいます。Ceaperのサービスを使用する中で、機能について不満に思った事や、ご要望などがございましたら、お気軽にご連絡ください。</p>
        <p style={{
            marginBottom: 0
          }}>当ページはお問い合わせのフォームではない為、原則ご返信は出来かねます。致命的な機能のバグ・不具合のご報告につきましては、ご返信と共に、早急なご対応をいたします。また返答が必要な質問やサポートが必要な場合は、
          <a className="grey-paragraph border-text" target="_blank" rel="nofollow noreferrer noopener" href="mailto: support@ceaper.com">サポート窓口</a>までお問い合わせください。</p>
      </div>
    </div>
      ...
      <div className='section center-section'>
        ...
        <div className="feedback-wrapper">
          ...
          <div className="form-select">
            <a className="icon-button ico select-button select-button-bottom">
              <Message/>フィードバックについて
            </a>
            <a className="icon-button ico select-button">
              <Bug/>バグ・不具合について
            </a>
          </div>
        </div>
