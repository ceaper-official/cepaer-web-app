      ...
      <div id="page">
        <div className='contents bg-snow'>
          <div className='section center-section'>
            ...
            <p className="">私達Ceaperは常にユーザーの方が心地良くサービスを使えるように新しい機能の開発・修正に挑んでいます。Ceaperのサービスを使用する中で、機能について不満に思った事や、ご要望などがございましたら、下記の質問に沿ってフィードバックを送信してください。</p>
            <p className="" style={{
                marginBottom: 0
              }}>なお、当ページはお問い合わせの窓口ではない為、原則ご返信は出来かねます。致命的な機能のバグ・不具合のご報告につきましては、ご返信と共に早急なご対応をいたします。また返答が必要な場合は、
              <a target="_blank" rel="nofollow noreferrer noopener" href="mailto: support@ceaper.com" className="">サポート窓口</a>までお問い合わせください。</p>
          </div>
        </div>
...
function FeedBackStep3() {
  return (
            <div className="feedback-wrapper">
              ...
              <a className="button button-snow form-submit">フィードバックを送る
              </a>
            </div>
);
}
