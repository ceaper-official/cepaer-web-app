...
class Counter extends React.Component {
  ...
  render() {
    ...
    <div className={this.state.open ? 'dropdown-contents open card' : 'dropdown-contents hide card'}>
  <div className="dropdown-list">
    <a href="" className="dropdown-item">編集する</a>
  <a href="" className="dropdown-item">コレクションを削除</a>
  </div>
  </div>
  </div>
</div>
