...
<div className="edit-inner">
  ...
  <div className="user-container">
    <h3 className="edit-section-title section-title edit-item">プロフィール</h3>
...
<label className="edit-title s-text">自己紹介</label>
          <textarea className="edit-area">私は、料理が大好きな生粋のキャンパーです。週7で、キャンプに行っています！よく出没する場所は高尾山です。</textarea>
           </div>
  </div>
</div>
  ...
  <div className="edit-section" id="settings">
    <h3 className="edit-section-title section-title edit-item">アカウント設定</h3>
          <div className = "edit-item">
      <label className="edit-title s-text">Eメール</label>
<input className="input-inner edit-input-inner" autocorrect="off" autocapitalize="off" autocomplete="useremail" type="text" value="user@gmail.com"/>
 </div>
 <div className = "edit-item">
<label className="edit-title s-text">新しいEメール</label>
<input className="input-inner edit-input-inner" autocorrect="off" autocapitalize="off" autocomplete="useremail" type="text" />
</div>
</div>

  {/*項目・パスワード*/}
  <div className="edit-section" id="password">
    <h3 className="edit-section-title section-title edit-item">パスワード</h3>
          <div className = "edit-item">
      <label className="edit-title s-text">現在のパスワード</label>
<input className="input-inner edit-input-inner" autocomplete="userpassword" type="password" value="user@gmail.com"/>
 </div>
 <div className = "edit-item">
<label className="edit-title s-text">新しいパスワード</label>
<input className="input-inner edit-input-inner"type="password" value=""/>
</div>
</div>
  ...
  <div className="edit-section" id="social-settings">
    <h3 className="edit-section-title section-title edit-item">ソーシャルメディア</h3>
          <div className = "edit-item">
            ...
            <input className="input-inner w100" placeholder="ユーザーネームを入力してください"></input>
            </div>
 </div>
     <div className = "edit-item">
       ...
       <input className="input-inner w100" placeholder="ユーザーIDを入力してください"></input>
       </div>
</div>
    <div className = "edit-item">
  ...
  <div className="edit-section" id="connections">
    <h3 className="edit-section-title section-title edit-item">外部サービスのログイン連携</h3>
          <div className = "edit-item edit-connections">
        <div className="ico"><Google/>Google</div>
          <a className="button
...
<div className="ico"><Facebook/>Facebook</div>
 <a className="button button-black">連携する</a>
  ...
  <div className="edit-section" id="notifications">
    <h3 className="edit-section-title section-title edit-item">お知らせ</h3>
      <label className="edit-title s-text edit-item">アクティビティの通知</label>
  ...
  <label className=" edit-title s-text s-text edit-toggle-text">新しいフォロワー</label>
  </div>
   <div className = "edit-item edit-toggle-wrapper">
      <div  className="edit-toggle">
    <input id="toggle" className="toggle-input" type='checkbox' />
  ...
  <label className=" edit-title s-text s-text edit-toggle-text">投稿したレシピへのレビュー</label>
  </div>
  <div className = "edit-item edit-toggle-wrapper">
     <div  className="edit-toggle">
   <input id="toggle" className="toggle-input" type='checkbox' />
 ...
 <label className=" edit-title s-text s-text edit-toggle-text">フォローしているユーザーの投稿</label>
 </div>

 <label className="edit-title s-text edit-item">Ceaperの通知</label>
      <div className="hr edit-hr"></div>
 <div className = "edit-item edit-toggle-wrapper">
    <div  className="edit-toggle">
  <input id="toggle" className="toggle-input" type='checkbox' />
...
<label className=" edit-title s-text s-text edit-toggle-text">トレンドニュース（隔週）</label>
</div>
...
<label className=" edit-title s-text s-text edit-toggle-text">重要なお知らせ（アップデート等）</label>
</div>
  ...
  {/*項目・保存する*/}
  <div className="edit-section edit-item edit-save-button" id="save">
          <div>
