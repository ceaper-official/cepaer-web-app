...
<p className="white"  style={{ marginBottom: 0 }}>下記の手順に沿って、アカウントの削除の手続きを進めてください。なお、アカウントを削除する場合、これまでに投稿したレシピなどのアクティビティが全て削除されます。再度アカウントを作成する場合、以前無効にしたアカウントを使用・復旧する事は一切できません。また、その間に他のユーザーの方が、削除したユーザー名を使用できる為、以前使用していたユーザー名が使えない場合がございます。予めご了承ください。</p>
</div>
 </div>
...
<a  className="icon-button ico select-button select-button-bottom ico-big card">  <OtherColor/>その他
     ...
     <div className = "form-select">
     <textarea className="feedback-area" placeholder="例：サービスが使いにくく不便..."></textarea>
      </div>
