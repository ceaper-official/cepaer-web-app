...
<h1 class='title'>アカウントの無効化</h1>
<p  style={{ marginBottom: 0 }}>質問に沿って、アカウントの無効化の手続きを進めてください。なお、アカウントを無効化する場合、これまでに投稿したレシピなどのアクティビティが全て削除されます。再度アカウントを作成する場合、以前無効にしたアカウントを使用・復旧する事は一切できません。また、その間に他のユーザーの方が、無効化したユーザー名を使用できる為、以前使用していたユーザー名が使えない場合がございます。予めご了承ください。</p>
</div>
 </div>
 <div class='contents'>
 <div class='section center-section'>
