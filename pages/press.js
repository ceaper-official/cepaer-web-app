...
<p class="text-row  sub-title">Ceaperのロゴの使用は、必ずCeaperの了諾を得てからの使用となります。下記のリンクから、明確な使用目的、内容の詳細を記載したメールを送信してください。</p>
<a class="button add-button button-accent ico-back"  target="_blank" rel="nofollow noreferrer noopener" href="mailto: support@ceaper.com">コンタクト<ArrowR/></a>
</div>
 </div>
