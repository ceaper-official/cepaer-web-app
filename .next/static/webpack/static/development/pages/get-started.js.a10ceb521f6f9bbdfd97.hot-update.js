...
var Nav = function Nav(props) {
  ...
  var _loop = function _loop(i) {
    var isActive = props.currentStep === i;
    dots.push(__jsx("span", {
      key: "step-".concat(i),
      className: "".concat(styles.dot, " ").concat(isActive ? styles.active : ''),
      onClick: function onClick() {
        return props.goToStep(i);
      },
      __self: _this,
      __source: {
        fileName: _jsxFileName,
  ...
  for (var i = 1; i <= props.totalSteps; i += 1) {
    _loop(i);
  }
...
//# sourceMappingURL=get-started.js.a10ceb521f6f9bbdfd97.hot-update.js.map